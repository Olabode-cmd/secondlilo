                    ...
                    <div className="row roles">
                        <div className="col-md-6 left">
                            <div className="container sticky">
                                ...
                                <p className="subtitle">Lilo Social is hiring a full-time project manager to coordinate internal tasks, assist with client communication and
                                    calls, handle external clients requests, and lead communication between internal and external teams</p>
